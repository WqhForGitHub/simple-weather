...
export default {
  ...
  methods: {
    getTomorrowCard(val) {
      ParamidaPay.ApiCaller.get('/forecast', {
        ...
        if(response.HeWeather6[0].status == 'ok') {
          ...
          this.temp = this.tomWeatherObject.tmp_min + '~' + this.tomWeatherObject.tmp_max + '℃'
          else this.temp = this.tomWeatherObject.tmp_min
          if(this.tomWeatherObject.cond_txt_d !== this.tomWeatherObject.cond_txt_n)
            this.todayWeatherText = this.tomWeatherObject.cond_txt_d + '转' + this.tomWeatherObject.cond_txt_n
    ...
    getTomorrowWeatherIcon() {
      if(this.tomWeatherObject.cond_txt_d == '晴' || this.tomWeatherObject.cond_txt_n ==  '晴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '多云' || this.tomWeatherObject.cond_txt_n ==  '多云') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '少云' || this.tomWeatherObject.cond_txt_n == '少云') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '晴间多云' || this.tomWeatherObject.cond_txt_n == '晴间多云') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '阴' || this.tomWeatherObject.cond_txt_n == '阴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '有风' || this.tomWeatherObject.cond_txt_n == '有风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '平静' || this.tomWeatherObject.cond_txt_n == '平静') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '微风' || this.tomWeatherObject.cond_txt_n == '微风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '和风' || this.tomWeatherObject.cond_txt_n == '和风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '清风' || this.tomWeatherObject.cond_txt_n == '清风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '强风/劲风' || this.tomWeatherObject.cond_txt_n == '强风/劲风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '疾风' || this.tomWeatherObject.cond_txt_n == '疾风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大风' || this.tomWeatherObject.cond_txt_n == '大风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '烈风' || this.tomWeatherObject.cond_txt_n == '烈风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '风暴' || this.tomWeatherObject.cond_txt_n == '风暴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '狂爆风' || this.tomWeatherObject.cond_txt_n == '狂暴风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '飓风' || this.tomWeatherObject.cond_txt_n == '飓风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '龙卷风' || this.tomWeatherObject.cond_txt_n == '龙卷风') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '热带风暴' || this.tomWeatherObject.cond_txt_n == '热带风暴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '阵雨' || this.tomWeatherObject.cond_txt_n == '阵雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '强阵雨' || this.tomWeatherObject.cond_txt_n == '强阵雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雷阵雨' || this.tomWeatherObject.cond_txt_n == '雷阵雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '强雷阵雨' || this.tomWeatherObject.cond_txt_n == '强雷阵雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雷阵雨伴有冰雹' || this.tomWeatherObject.cond_txt_n == '雷阵雨伴有冰雹') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '小雨' || this.tomWeatherObject.cond_txt_n == '小雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '中雨' || this.tomWeatherObject.cond_txt_n == '中雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大雨' || this.tomWeatherObject.cond_txt_n == '大雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '极端降雨' || this.tomWeatherObject.cond_txt_n == '极端降雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '毛毛雨/细雨' || this.tomWeatherObject.cond_txt_n == '毛毛雨/细雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '暴雨' || this.tomWeatherObject.cond_txt_n == '暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大暴雨' || this.tomWeatherObject.cond_txt_n == '大暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '特大暴雨' || this.tomWeatherObject.cond_txt_n == '特大暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '冻雨' || this.tomWeatherObject.cond_txt_n == '冻雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '小到中雨' || this.tomWeatherObject.cond_txt_n == '小到中雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '中到大雨' || this.tomWeatherObject.cond_txt_n == '中到大雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大到暴雨' || this.tomWeatherObject.cond_txt_n == '大到暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '暴雨到大暴雨' || this.tomWeatherObject.cond_txt_n == '暴雨到大暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大暴雨到特大暴雨' || this.tomWeatherObject.cond_txt_n == '大暴雨到特大暴雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雨' || this.tomWeatherObject.cond_txt_n == '雨') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '小雪' || this.tomWeatherObject.cond_txt_n == '小雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '中雪' || this.tomWeatherObject.cond_txt_n == '中雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大雪' || this.tomWeatherObject.cond_txt_n == '大雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '暴雪' || this.tomWeatherObject.cond_txt_n == '暴雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雨夹雪' || this.tomWeatherObject.cond_txt_n == '雨夹雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雨雪天气' || this.tomWeatherObject.cond_txt_n == '雨雪天气') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '阵雨夹雪' || this.tomWeatherObject.cond_txt_n == '阵雨夹雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '阵雪' || this.tomWeatherObject.cond_txt_n == '阵雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '小到中雪' || this.tomWeatherObject.cond_txt_n == '小到中雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '中到大雪' || this.tomWeatherObject.cond_txt_n == '中到大雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大到暴雪' || this.tomWeatherObject.cond_txt_n == '大到暴雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雪' || this.tomWeatherObject.cond_txt_n == '雪') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '薄雾' || this.tomWeatherObject.cond_txt_n == '薄雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '雾' || this.tomWeatherObject.cond_txt_n == '雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '霾' || this.tomWeatherObject.cond_txt_n == '霾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '扬沙' || this.tomWeatherObject.cond_txt_n == '扬沙') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '浮尘' || this.tomWeatherObject.cond_txt_n == '浮尘') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '沙尘暴' || this.tomWeatherObject.cond_txt_n == '沙尘暴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '强沙尘暴' || this.tomWeatherObject.cond_txt_n == '强沙尘暴') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '浓雾' || this.tomWeatherObject.cond_txt_n == '浓雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '强浓雾' || this.tomWeatherObject.cond_txt_n == '强浓雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '中度霾' || this.tomWeatherObject.cond_txt_n == '中度霾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '重度霾' || this.tomWeatherObject.cond_txt_n == '重度霾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '严重霾' || this.tomWeatherObject.cond_txt_n == '严重霾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '大雾' || this.tomWeatherObject.cond_txt_n == '大雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '特强浓雾' || this.tomWeatherObject.cond_txt_n == '特强浓雾') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '热' || this.tomWeatherObject.cond_txt_n == '热') {
      ...
      } else if(this.tomWeatherObject.cond_txt_d == '冷' || this.tomWeatherObject.cond_txt_n == '冷') {
